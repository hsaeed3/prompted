...
__console__: None | Console = None
"""Singleton console instance for the `prompted` package."""


RichColor: TypeAlias = Literal[
    "black",
    "red",
    "green",
    "yellow",
...
"""Type alias helper for all standard rich colors."""


def get_console() -> Console:
    """
    Internal helper function for getting the console instance.
    """
    global __console__
    if __console__ is None:
        __console__ = Console()
    return __console__
...
def set_console(console: Console) -> None:
    """
    Internal helper function for setting the console instance.
    """
    global __console__
    __console__ = console
...
"""Singleton logger for the `prompted` package."""
